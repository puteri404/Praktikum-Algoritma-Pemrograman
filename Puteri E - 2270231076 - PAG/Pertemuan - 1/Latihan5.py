...
data_int = int(data_bool) # akan dibutuhkan ke bawah
...
data_int = int(input(data_str)) # string harus angka
data_int = float(data_str) # string harus angka
data_int = bool(data_str) # false jika string kosong
print("data =", data_int, ",type =",type(data_int))
print("data =", data_float, ",type =",type(data_float))
print("data =", data_bool, ",type =",type(data_bool))